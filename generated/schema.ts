...
export class Gaussian extends Entity {
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save Gaussian entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save Gaussian entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("Gaussian", id.toString(), this);
  }

  static load(id: string): Gaussian | null {
    return store.get("Gaussian", id) as Gaussian | null;
  }
